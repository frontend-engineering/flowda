...
function extendApi(schema, SchemaObject = {}) {
    const newSchema = new schema.constructor(Object.assign(Object.assign({}, schema._def), { openapi: SchemaObject /* for zod-openapi */ }));
    newSchema.metaOpenApi = Object.assign({}, schema.metaOpenApi /* for @anatine/zod-openapi */ || {}, SchemaObject);
    return newSchema;
}
