...
declare const configSchema: z.ZodObject<
  {
    ...
    defaultInvisibleField: z.ZodEffects<
      z.ZodDefault<z.ZodOptional<z.ZodString>>,
      string[],
      string | undefined
    >;
    defaultReadOnlyField: z.ZodEffects<
      z.ZodDefault<z.ZodOptional<z.ZodString>>,
      string[],
      string | undefined
    >;
...
declare class ExtendedDMMFModel
...
declare class ExtendedDMMFSchema implements DMMF.Schema {
  ...
  getModelWithIncludeAndSelect(
    field: ExtendedDMMFSchemaField,
  ): ExtendedDMMFOutputType | undefined;
}
...
interface ExtendedDMMFSchemaArgOptions
...
declare class ExtendedDMMFSchemaArg
  extends FormattedNames
...
declare class ExtendedDMMFInputType
  extends FormattedNames
...
type FilterdPrismaAction = Exclude<
  PrismaAction,
  'executeRaw' | 'queryRaw' | 'count'
>;

declare class ExtendedDMMFSchemaField
  extends FormattedNames
...
declare class ExtendedDMMFOutputType
  extends FormattedNames
...
declare class ExtendedDMMFSchemaArgInputType
...
declare class ExtendedDMMFSchemaEnum
  extends FormattedNames
...
declare const loadDMMF: (
  schemaPath: string,
) => Promise<_prisma_generator_helper.DMMF.Document>;

declare const parseGeneratorConfig: (
...
declare const generateSingleFile: ({
  dmmf,
  path,
}: CreateOptions) => void;

declare const generateMultipleFiles: ({
  dmmf,
  path,
}: CreateOptions) => void;
