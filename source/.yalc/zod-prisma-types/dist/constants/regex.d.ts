...
export declare const VALIDATOR_CUSTOM_ERROR_REGEX_ALT: RegExp;
...
export declare const PRISMA_FUNCTION_TYPES_WITH_VALIDATORS_WHERE_UNIQUE: RegExp;
export declare const IMPORT_STATEMENT_REGEX_PATTERN: RegExp;
export declare const IMPORT_STATEMENT_REGEX: RegExp;
export declare const JSDOC_SCHEMA_TAG_REGEX: RegExp;
