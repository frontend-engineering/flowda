export namespace Color {
    ...
    export function hsla(h: number, s: number, l: number, a: number = 1) {
        return {};
    }
    export const white = rgba(255, 255, 255, 1);
    export const black = rgba(0, 0, 0, 1);
    export function transparent(v: string, f: number) {
        return {};
    }
    export function lighten(v: string, f: number) {
        return {};
    }
    export function darken(v: string, f: number) {
        return {};
    }
}
export const colors = [
